...
@section('content')
    ...
    <section class="content">
            ...
            <div class="box-header with-border">
              ...
              <a class="btn btn-success pull-right" href="{{route('customers.create')}}">Thêm</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td style="width: 25%">
                    <a class="btn btn-primary" href="{{route('customers.show',$customer->id)}}"><i class="fa fa-eye"></i> Xem </a>
                    <a class="btn btn-warning" href="{{route('customers.edit',$customer->id)}}"><i class="fa fa-edit"></i> Sửa </a>
